...
export const localAnnouncements: Announcement[] = [
  {
    ...
    summary: 'A simpler place to discover startups, share ideas, and find your next opportunity.',
    content: 'Explore the feed, follow interesting startups, and use mentorship pages to connect with people building the future.',
  ...
  },
  {
    ...
    summary: 'Catalogues are getting a fresh layout designed for browsing and sharing.',
    content: 'We are polishing collections, product details, and discovery so your work gets the attention it deserves.',
